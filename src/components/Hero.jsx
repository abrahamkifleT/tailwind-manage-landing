    ...
    <section id="hero">
        ...
        <div className="container flex flex-col-reverse md:flex-row items-center px-6 mx-auto mt-10 space-y-0 md:space-y-0">
           ...
           <div className='flex flex-col mb-32 space-y-12 md:w-1/2'>
              ...
              <p className='max-w text-center text-darkGrayishBlue md:text-left'>Manage makes it simple for software teams to plan day-to-day tasks while keeping the larger team goals in view.</p>
